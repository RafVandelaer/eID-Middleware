...
namespace eidReader
{
    public class ReadData
    {
        ...
        /// <summary>
        /// Get the info of the eID in JSON (Raf)
        /// </summary>
        /// <returns></returns>
        public idInfo GetInfo()
        {
            ...
            try
            {
                ...
                //id.date_of_birth = GetData("date_of_birth");
                id.date_of_birth = GetDateOfBirth();
                id.nationality = GetData("nationality");
                id.name = GetData("firstnames");
                id.surname = GetData("surname");
                id.gender = GetData("gender");
                id.addressAndNumber = GetData(label: "address_street_and_number");
                id.zipcode = GetData("address_zip");
                id.photo = GetPhotoFile();
            }
            catch (Exception ex)
            {
